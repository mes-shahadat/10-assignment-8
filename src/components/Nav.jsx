...
function Nav() {
    ...
    useEffect(
        () => {
            ...
            else if (pathname === "/technical-support") {
                title.innerText = "Support | Gadgets Haven";
            }
                ...
                <nav className={`flex max-sm:flex-col items-center sm:justify-around ${pathname === '/' || pathname.includes("/products/") ? "bg-[#943fdd] text-white" : " "} py-5 px-2 rounded-t-2xl`}>
                    ...
                    <div className="flex gap-2 sm:gap-5">
                        ...
                        <div className="inline-block relative">
                            <div className="inline-flex cursor-pointer" onClick={() => handleShown('links')}>
                                Support
                    ...
                    <div className="inline-flex gap-4 max-sm:hidden">
                        <div className="relative">
                            <div className="relative">
                                <button className="w-9 bg-white rounded-full p-2 text-black" onClick={() => handleShown('cart')}>
                                ...
                                <small className="absolute -top-4 -right-3 text-red-600 bg-white rounded-xl px-2 border">1</small>
                            </div>
                        ...
                        <div className="relative">
                            <div className="relative">
                                <button className="w-9 bg-white rounded-full p-2 text-black" onClick={() => handleShown('wishlist')}>
